...
export const Projects = () => {
  return (
    <Article>
      <Title className="pb-2 border-b-2 border-blue-400">Projects</Title>
...
const ProejectArray = [
  {
    title: "MyPortfolio",
    summary:
      "포트폴리오를 웹 형태로 제작한 프로젝트 입니다. 사용한 기술을 복습하며, 저만의 웹 포트폴리오를 만들기위해 제작하게 되었습니다",
    category: "solo",
    personnel: [1],
    role: "프론트엔드 담당",
  ...
  },
  {
    ...
    functions: [
      "유저관련 페이지 구현(구글 로그인,마이페이지) - 소셜로그인(Google)으로 회원가입 및 로그인시 발급받는 JWT 토큰을 쿠키로 관리, 유저정보는 ContextAPI를 사용하여 전역적 관리",
      "사용자들의 질답 또는 스터디모집을 위해 소통을 할 수있는 커뮤니티 페이지 - React-query의 Mutation 사용하여 댓글목록 및 게시글 목록에 낙관적 업데이트 적용",
      "강의 상세페이지 및 강의 결제 기능 구현 - PortOne(모든 결제를 지원하는 API)을 사용하여 테스트 결제 적용",
      "강의를 추후에 구매할 수 있도록 장바구니 페이지 구현",
      "강사 권한이 등록된 사용자가 강의등록 할 수 있는 페이지 구현",
  ...
  },
  {
    title: "Trip_Fixie",
    summary:
      "여행일정에 맞춰 관광지 정보와 축제정보, 숙소 정보를 제공하여 일정을 계획하고 비교하기 쉽도록 도움을 제공하는 서비스",
    category: "team",
    personnel: [1, 1],
    role: "프론트엔드 담당",
    ...
    functions: [
      ...
      "제공된 장소의 상세정보와 위치정보를 TourAPI(4.0), NAVER Maps API 을 통해 제공 ",
